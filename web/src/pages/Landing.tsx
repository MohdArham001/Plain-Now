            ...
            <main className="pt-32 pb-16 px-6">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    >
                        <button
                            onClick={handleStart}
                            className="w-full sm:w-auto bg-indigo-600 text-white h-14 px-8 rounded-full font-bold text-lg hover:bg-indigo-700 transition-all hover:scale-105 active:scale-95 shadow-xl shadow-indigo-200 flex items-center justify-center gap-2"
                        >
                        ...
                        <button
                            ...
                            className="w-full sm:w-auto bg-white text-gray-700 h-14 px-8 rounded-full font-bold text-lg hover:bg-gray-50 border border-gray-200 transition-all hover:scale-105 active:scale-95 flex items-center justify-center gap-2 shadow-sm group">
                    ...
                    <motion.div
                        ...
                        className="flex flex-wrap items-center justify-center gap-8 md:gap-16 border-t border-gray-100 pt-10"
                    >
